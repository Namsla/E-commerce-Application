  ...
  return (
    <section className="flex flex-col lg:flex-row dark:text-slate-100 items-center">
      <div className="text my-5">
        <h1 className="text-5xl font-bold">The Ultimate e-Store</h1>
        <p className="text-2xl my-7 px-1 dark:text-slate-300">
          Bazaar is the world's most popular and authoritative source for online
          shopping items. Find ratings and access to the newest items.
        </p>
        <Link
          to="/products"
          type="button"
